        ...
        <div class="col-md-8">
   			<div class="container">
				<table class="table table-striped">
				  ...
				  <tbody>
				  	<tag:forEach var="appointmnet" items="${assignAppointmnetList}">
					    <tr>
					      ...
					      <td>${appointmnet.availability}</td>
						  <td>
					      	<form action="appointment?type=update" method="post">					      		
									<div class="mb-3">
									  <label for="statusSelect" class="form-label">Select Consultant</label>
									  <select class="form-select" name="assignConsultant" id="assignConsultant">
									    <option value="emp01">Buwaneka Jayasundara</option>
									    <option value="emp02">Ravindu Bandara</option>
									    <option value="emp03">Navodi</option>
									  </select>
									</div>
