...
<head>
    ...
    <title> View Consultants Availability</title>
  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">View Consultants</li>
      </ol>
				...
				<table class="table table-striped">
				  <thead>
				    <tr class="table-dark">
				      ...
				      <th scope="col">Edit Consultants</th>
				    </tr>
				  </thead>
				  <tbody>
