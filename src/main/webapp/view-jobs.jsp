      ...
      <ul class="navbar-nav navbar-sidenav" id="exampleAccordion">
        <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Dashboard">
          <a class="nav-link" href="index.html">
            ...
            <span class="nav-link-text">Admin 360</span>
          </a>
        </li>
        ...
        <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Products">
          ...
          <ul class="sidenav-second-level collapse" id="collapseVehicleCat">
            ...
            <li>
              <a href="delete-job.jsp">Delete Jobs</a>
            </li>
            <li>
              <a href="/smartconsultants-online/job">View Jobs</a>
            </li>
          </ul>
        </li>
  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">View Job Types</li>
      </ol>
      <div class="row justify-content-center">
        <div class="col-md-8">
   			<div class="container">
				<div class="input-group mb-3">
				  <input type="text" class="form-control" placeholder="Job ID" aria-label="Recipient's username" aria-describedby="basic-addon2">
				  ...
				  <thead>
				    <tr class="table-dark">
				      ...
				      <th scope="col">Job Type Name</th>
   				      <th scope="col">Job Type ID</th>
				      <th scope="col">Country Specialisation ID</th>
				      <th scope="col">Delete</th>
				    </tr>
				  </thead>
				  <tbody>
				  	<tag:forEach var="jobs" items="${jobList}">
					    <tr>
					      <td>${jobs.job_type_specialization_id}</td>
					      <td>${jobs.job_type_name}</td>
   					      <td>${jobs.country_specialization_id}</td>
					      <td>${jobs.employee_id}</td>

					      <td>
					      	<form action="job?type=delete" method="post">
					      		<button type="submit" class="btn btn-danger">Delete</button>
					      		<input type="hidden" name="job_type_specialization_id" id="job_type_specialization_id" value="${jobs.job_type_specialization_id}">
					      	</form>
						  </td>
					    </tr>
				    </tag:forEach>
